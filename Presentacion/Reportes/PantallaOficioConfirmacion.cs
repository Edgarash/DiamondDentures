...
namespace Presentacion.Reportes
{
    class PantallaOficioConfirmacion : Pantalla
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.pictureBox1.BackgroundImage = global::Presentacion.Properties.Resources.IconoOTerminacion;
        ...
        public PantallaOficioConfirmacion(string clave)
        {
            InitializeComponent();
        ...
        private void sfdGuardar_FileOk(object sender, CancelEventArgs e)
        {
            ...
            {
                ExportarReporte(sfdGuardar.FileName, (ReportDocument) crVisor.ReportSource);
            }
            Cursor = Cursors.Default;
        }
