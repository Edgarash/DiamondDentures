...
{
    class PantallaVPNotaPagos : Pantalla
    {
        public PantallaVPNotaPagos()
        {
            InitializeComponent();
        }
        ...
        private void CargarReporte()
        {
            ...
            crvVisor.ReportSource = ManejadorReportes.CargarReporte(new ReportePago(), Id);
        }
        ...
        private void sfdExportar_FileOk(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            ManejadorReportes.ExportarReporte(ruta, (ReportePago) crvVisor.ReportSource);
        }
