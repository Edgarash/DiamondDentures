...
namespace Presentacion.Reportes
{
    ...
    class PantallaVPMatCom : Pantalla
    {
        public PantallaVPMatCom()
        {
            InitializeComponent();
        }
        ...
        private void CargarReporte()
        {
            ...
            crvVisor.ReportSource = ManejadorReportes.CargarReporte(new ReporteMaterialesComprados());
        }
        ...
        private void sfdExportar_FileOk(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            ManejadorReportes.ExportarReporte(ruta, (ReporteMaterialesComprados) crvVisor.ReportSource);
        }
    }
}