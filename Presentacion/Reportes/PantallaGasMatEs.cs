...
namespace Presentacion.Reportes
{
    ...
    class PantallaGasMatEs : Pantalla
    {
        public PantallaGasMatEs()
        {
            InitializeComponent();
        }
        ...
        private void sfdExportar_FileOk(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            ManejadorReportes.ExportarReporte(ruta, (ReporteGastoMEsp) crvVisor.ReportSource);
        }
    }
}