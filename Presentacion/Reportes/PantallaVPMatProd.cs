...
namespace Presentacion.Reportes
{
    ...
    class PantallaVPMatProd : Pantalla
    {
        public PantallaVPMatProd()
        {
            InitializeComponent();
        }
        ...
        private void CargarReporte()
        {
            ...
            crvVisor.ReportSource = ManejadorReportes.CargarReporte(new ReporteProductoMateriales());
        }
        ...
        private void sfdExportar_FileOk(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            ManejadorReportes.ExportarReporte(ruta, (ReporteProductoMateriales) crvVisor.ReportSource);
        }
    }
}