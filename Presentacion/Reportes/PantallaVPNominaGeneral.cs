...
namespace Presentacion.Reportes
{
    ...
    class PantallaVPNominaGeneral : Pantalla
    {
        public PantallaVPNominaGeneral()
        {
            InitializeComponent();
        }
        ...
        private void CargarReporte() => crvVisor.ReportSource = ManejadorReportes.CargarReporte(new ReporteNomina());
        ...
        private void sfdExportar_FileOk(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            ManejadorReportes.ExportarReporte(ruta, (ReporteNomina) crvVisor.ReportSource);
        }
    }
}