       ...
       private System.Windows.Forms.Label label1;
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(txtRFC.Text))
                Factura.RfcCliente = txtRFC.Text;
            else
            {
            ...
            if (!string.IsNullOrWhiteSpace(txtDireccion.Text))
                Factura.DireccionCliente = txtDireccion.Text;
            else
            {
            ...
            if (!string.IsNullOrWhiteSpace(txtCodigoPostal.Text))
                Factura.CpCliente = Convert.ToUInt32(txtCodigoPostal.Text);
                    else
            {
            ...
            if (!string.IsNullOrWhiteSpace(txtCiudad.Text))
                Factura.CiudadCliente = txtCiudad.Text;
            else
            {
            ...
            {
                Factura.EstadoCliente = cmbEstado.SelectedItem.ToString();
                cmbEstado.Refresh();
            }
            else
            {
            ...
            if (!string.IsNullOrWhiteSpace(mtbTelefono.Text))
                Factura.TelefonoCliente = mtbTelefono.Text;
            else
            {
