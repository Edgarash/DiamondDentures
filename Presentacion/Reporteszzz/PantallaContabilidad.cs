...
namespace Presentacion.Reportes
{
    internal class PantallaContabilidad : Pantalla
    {
        ...
        private void MostrarFacturas(List<Factura> facturas)
        {
            ...
            foreach (Factura factura in facturas)
            {
                ...
                dgvFacturas["cid", dgvFacturas.RowCount - 1].Value = factura.FacturaId;
                dgvFacturas["cnombre", dgvFacturas.RowCount - 1].Value = factura.NombreCliente;
                dgvFacturas["ctelefono", dgvFacturas.RowCount - 1].Value = factura.TelefonoCliente;
                dgvFacturas["cfecha", dgvFacturas.RowCount - 1].Value = factura.FechaEmision.ToShortDateString();
                dgvFacturas["cmonto", dgvFacturas.RowCount - 1].Value = factura.Importe;
                dgvFacturas["cestado", dgvFacturas.RowCount - 1].Value = factura.Vigencia == 1 ? "Vigente" : "Cancelada";
            }
        }
   ...
   private ContextMenuStrip cmsTabla;
        ...
        private void InitializeComponent()
        {
            ...
            // btnEnviarFactura
            // 
            this.btnEnviarFactura.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("btnEnviarFactura.BackgroundImage")));
            ...
            this.btnEnviarFactura.Location = new System.Drawing.Point(904, 352);
            ...
            this.label11.Location = new System.Drawing.Point(878, 414);
            ...
            // btnBuscarFacturas
            // 
            this.btnBuscarFacturas.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("btnBuscarFacturas.BackgroundImage")));
        ...
        {
            if (DateTime.Today != (DateTime) dgvFacturas.SelectedRows[0].Cells["cfecha"].Value)
                MessageBox.Show("Unicamente se puede cancelar una factura el mismo dia de su emision","Advertencia",MessageBoxButtons.OK,MessageBoxIcon.Warning);
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (factura.FacturaId == (int) dgvFacturas.SelectedRows[0].Cells["cid"].Value)
                {
