  ...
  private void InitializeComponent()
        {
            ...
            this.Encabezado.Size = new System.Drawing.Size(844, 101);
            // 
            // panel1
            // 
            ...
            this.label13.Location = new System.Drawing.Point(639, 656);
            ...
            this.label14.Location = new System.Drawing.Point(745, 656);
            ...
            this.label2.Location = new System.Drawing.Point(622, 495);
            ...
            this.label3.Location = new System.Drawing.Point(732, 495);
            ...
            this.btnBuscarPedido.Location = new System.Drawing.Point(639, 429);
...
//            this.btnLimpiar.BackgroundImage = global::Presentacion.Properties.Resources.IconoLimpiar;
            ...
            this.btnLimpiar.Location = new System.Drawing.Point(748, 429);
            ...
            this.btnAceptar.Location = new System.Drawing.Point(639, 592);
            ...
            // button4
            // 
            this.button4.BackgroundImage = global::Presentacion.Properties.Resources.IconoCancelar;
            this.button4.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
            this.button4.FlatAppearance.BorderSize = 0;
            this.button4.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
            this.button4.Location = new System.Drawing.Point(748, 592);
            ...
            //this.pictureBox1.BackgroundImage = global::Presentacion.Properties.Resources.IconoGenerarFactura;
            ...
            this.dgvTabla.Size = new System.Drawing.Size(545, 260);
            ...
            this.pictureBox6.Location = new System.Drawing.Point(625, 420);
            ...
            this.label21.Location = new System.Drawing.Point(625, 403);
            ...
            this.btnModificar.Location = new System.Drawing.Point(694, 188);
        ...
        void MostrarDatos()
        {
            lblFacturaId.Text = $"{TextosDefault.NFactura} {Factura.FacturaId}";
            lblFechaEmision.Text = $"{TextosDefault.FechaEmision} {Factura.FechaEmision}";
            lblNombreCliente.Text = $"{TextosDefault.Nombre} {Factura.NombreCliente}";
            lblNombreEmpresa.Text = $"{TextosDefault.Nombre} {Factura.NombreEmpresa}";
            lblRfcCliente.Text = $"{TextosDefault.Rfc} {Factura.RfcCliente}";
            lblRfcEmpresa.Text = $"{TextosDefault.Rfc} {Factura.RfcEmpresa}";
            lblDireccionCliente.Text = $"{TextosDefault.Direccion} {Factura.DireccionCliente}";
            lblDireccionEmpresa.Text = $"{TextosDefault.Direccion} {Factura.DireccionEmpresa}";
            lblCodigoPostalCliente.Text = $"{TextosDefault.CodigoPostal} {Factura.CpCliente}";
            lblCodigoPostalEmpresa.Text = $"{TextosDefault.CodigoPostal} {Factura.CpEmpresa}";
            lblCiudadCliente.Text = $"{TextosDefault.Ciudad} {Factura.CiudadCliente}";
            lblCiudadEmpresa.Text = $"{TextosDefault.Ciudad} {Factura.CiudadEmpresa}";
            lblEstadoCliente.Text = $"{TextosDefault.Estado} {Factura.EstadoCliente}";
            lblEstadoEmpresa.Text = $"{TextosDefault.Estado} {Factura.EstadoEmpresa}";
            lblTelefonoCliente.Text = $"{TextosDefault.Telefono} {Factura.TelefonoCliente}";
            lblTelefonoEmpresa.Text = $"{TextosDefault.Telefono} {Factura.TelefonoEmpresa}";
            lblCorreoEmpresa.Text = $"{TextosDefault.Correo} {Factura.CorreoEmpresa}";
            
            dgvTabla.Rows.Clear();
            foreach (Productos producto in Factura.ListaProductos)
            {
                dgvTabla.RowCount++;
                dgvTabla["cnumero", dgvTabla.RowCount - 1].Value = producto.Id;
                dgvTabla["cdescripcion", dgvTabla.RowCount - 1].Value = producto.Descripcion;
                dgvTabla["ccantidad", dgvTabla.RowCount - 1].Value = producto.Cantidad;
                dgvTabla["cpreciounitario", dgvTabla.RowCount - 1].Value = producto.Costo;
                dgvTabla["cimporte", dgvTabla.RowCount - 1].Value = (double) (producto.Cantidad*producto.Costo);
            }
Refresh();
        }
